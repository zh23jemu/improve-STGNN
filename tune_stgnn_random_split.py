...
def build_candidates():
    ...
    configs = [
        ("eq_seed42", Config(**common, geo_weight=0.33, econ_weight=0.33, digital_weight=0.34, seed=42)),
        ("eq_seed52", Config(**common, geo_weight=0.33, econ_weight=0.33, digital_weight=0.34, seed=52)),
        ("eq_seed62", Config(**common, geo_weight=0.33, econ_weight=0.33, digital_weight=0.34, seed=62)),
        ("main_seed42", Config(**common, geo_weight=0.40, econ_weight=0.35, digital_weight=0.25, seed=42)),
        ("main_seed52", Config(**common, geo_weight=0.40, econ_weight=0.35, digital_weight=0.25, seed=52)),
        ("main_seed62", Config(**common, geo_weight=0.40, econ_weight=0.35, digital_weight=0.25, seed=62)),
        ("digital_seed42", Config(**common, geo_weight=0.25, econ_weight=0.25, digital_weight=0.50, seed=42)),
        ("digital_seed52", Config(**common, geo_weight=0.25, econ_weight=0.25, digital_weight=0.50, seed=52)),
        ("digital_seed62", Config(**common, geo_weight=0.25, econ_weight=0.25, digital_weight=0.50, seed=62)),
        ("geo_seed42", Config(**common, geo_weight=0.50, econ_weight=0.30, digital_weight=0.20, seed=42)),
        ("geo_seed52", Config(**common, geo_weight=0.50, econ_weight=0.30, digital_weight=0.20, seed=52)),
        ("geo_seed62", Config(**common, geo_weight=0.50, econ_weight=0.30, digital_weight=0.20, seed=62)),
    ]
    return configs
...
def main():
    ...
    out_json = DATA_DIR / "stgnn_random_split_results.json"
    out_md = DATA_DIR / "stgnn_random_split_results.md"
